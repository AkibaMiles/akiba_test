...
const physicalGoodsRaffles = [
  {
    ...
    title: 'Airpods 2',
    endsIn: 6,
    ticketCost: '3 AkibaMiles for 1 ticket',
  },
  {
    image: laptop,
    title: 'Laptop',
...
const nftRaffles = [
  ...
  },
  {
    ...
    endsIn: 3,
    ticketCost: '12 AkibaMiles',
  },
];

const upcomingGames = [
  { name: 'Dice', date: 'live', image: Dice },
        ...
        <div className="flex gap-3 overflow-x-auto">
          ...
          {physicalRaffles.length === 0 && (
            <div className="text-sm opacity-70 px-2 py-4">
              No physical raffles live right now.
            </div>
          )}
        </div>
      </div>
      ...
      <div>
        ...
        <div className="flex space-x-3 overflow-x-auto px-4">
          {upcomingGames.map((game, idx) => {
            ...
            // Dice is live → clicking should open /dice
            if (game.name === 'Dice') {
              return (
                <Link
                  key={idx}
            ...
            // Other games stay as non-clickable previews
            return (
