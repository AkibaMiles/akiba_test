...
/// @title AkibaClawGame
/// @notice Three-tier claw machine game backed by Witnet verifiable randomness.
///
///         Tiers:
...
///
///         Flow:
///           startGame(tierId)      — pay, request Witnet randomness, open session
///           settleGame(sessionId)  — anyone calls once Witnet is ready; determines outcome
...
///
///         Settlement is permissionless; a backend keeper should monitor pending sessions.
    ...
    ReentrancyGuardUpgradeable
{
    ...
    /// @notice Accept CELO top-ups for the Witnet fee reserve.
    receive() external payable {}

    /// @notice Withdraw CELO from the fee reserve. Admin only.
